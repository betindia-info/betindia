...
export const cmsConfig = {
  ...
  sports: {
    ...
    seoBlocks: [
      ...
      { name: "sportsbookTitle", label: "Sportsbook Title", type: "text" },
      { name: "sportsbookText", label: "Sportsbook Text", type: "textarea" },
      { name: "availableMarketsTitle", label: "Available Markets Title", type: "text" },
      { name: "availableMarketsText", label: "Available Markets Text", type: "textarea" },
      { name: "whyChooseTitle", label: "Why Choose Title", type: "text" },
      { name: "whyChooseText", label: "Why Choose Text", type: "textarea" },
    ],
    finalCta: [
