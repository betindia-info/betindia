    ...
    <section className="relative overflow-hidden bg-[#050B18]">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:gap-14 lg:px-8 lg:py-24">
        <div className="order-2 flex flex-col items-center text-center lg:order-1 lg:items-start lg:text-left">
          <span className="inline-flex items-center gap-2 rounded-full border border-[#eab308]/30 bg-[#eab308]/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-[#eab308]">
        ...
        <div className="order-1 lg:order-2">
          <div className="relative mx-auto max-w-sm lg:max-w-none">
            <div className="pointer-events-none absolute inset-0 rounded-3xl bg-[#eab308]/10 blur-3xl" />
            <div
              className="relative rounded-3xl p-px"
              style={{ background: "linear-gradient(135deg, #FF6B00 0%, #eab308 40%, #138808 80%, #FF6B00 100%)" }}
            >
              <div className="relative overflow-hidden rounded-[calc(1.5rem-1px)] bg-[#081425] p-6 sm:p-7">
                <div className="relative mb-5 flex items-center justify-between">
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-500">Wimbledon · Final</p>
                    <p className="mt-0.5 text-[11px] font-bold text-slate-400">Centre Court · Set 3</p>
                  </div>
                ...
                <div className="relative mb-4 rounded-2xl border border-white/[0.07] bg-white/[0.03] p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex flex-1 flex-col items-center gap-1">
                      ...
                      <p className="text-xs font-bold text-white">Djokovic</p>
                    ...
                    <div className="rounded-xl border border-white/[0.07] bg-white/[0.04] px-4 py-2 text-center">
                      <p className="text-sm font-black text-white">6 — 4</p>
                      <p className="text-[9px] text-slate-500">Current Set</p>
                    </div>
                    <div className="flex flex-1 flex-col items-center gap-1">
                      <span className="text-2xl">🎾</span>
                      <p className="text-xs font-bold text-white">Alcaraz</p>
                ...
                <div className="relative mb-4 grid grid-cols-2 gap-2">
                  {[
                    { label: "Djokovic Win", odds: "1.72" },
                    { label: "Alcaraz Win", odds: "2.15" },
                  ].map(({ label, odds }) => (
                    <button
                      key={label}
                ...
                <div className="relative rounded-xl border border-white/[0.06] bg-white/[0.03] p-3">
                  ...
                  {["Ace — Djokovic", "Break Point Saved", "Deuce"].map((event) => (
